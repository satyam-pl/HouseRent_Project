          ...
          <div class="form-group">
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="province" required="required">
                                ...
                                <option value="Province No. 2">Gujarat</option>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="district" required="required">
                                ...
                                %{--Gujarat--}%
                                <option value="Kutuch">Kutuch</option>
                                ...
                                <option value="Solukhumbu">Kolhapur</option>
                                <option value="Mumbai">Mumbai</option>
                                <option value="Pune">Pune</option>
                                <option value="Thane">Thane</option>
                                %{--Madhyapradesh--}%
                                <option value="AshikNagar">AshokNagar</option>
                                ...
                                <option value="Maysor">Maysor</option>
            ...
            <div class="form-group">
              ...
              <select class="form-control" name="vdc_municipality">
                ...
                <option value="Municiple Corporation">Municiple Corporation</option>
...
<div id="map_canvas"></div>
        ...
        <div class="col-sm-6">
          <div class="form-group">
            ...
            <div class="form-group">
              <label for="vdc/municipality">Municipality:</label>
              <select class="form-control" name="vdc_municipality">
                <option value="">--Select VDC/Municipality--</option>
                <option value="VDC">Municiple Corporation</option>
                <option value="Municipality">Municipality</option>
              </select>
